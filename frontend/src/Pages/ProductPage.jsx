...
function ProductPage() {
    return (
        <div>
            <section class="text-[#A6ADBA] body-font overflow-hidden">
                <div class="container px-5 py-24 mx-auto">
                    <div class="lg:w-4/5 mx-auto flex flex-wrap">
                        ...
                        <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <h1 class="text-[#A6ADBA] text-3xl title-font font-medium mb-1">Product Title</h1>
                            <div class="flex mb-4">
                                <span class="flex items-center">
                                    ...
                                    <span class="text-gray-600 ml-3">73262</span>
                                </span>
                            ...
                            <p class="leading-relaxed">Product Description here</p>
                            <div class="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                                ...
                                <div class="flex ml-6 items-center">
                                    ...
                                    <div class="relative">
                                        <select className="select select-bordered  max-w-[85px]">
                            ...
                            <div class="flex">
                                <span class="title-font font-medium text-2xl text-[#A6ADBA]">$9999</span>
