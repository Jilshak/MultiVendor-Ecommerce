...
function Card() {
    return (
        <>
            <div class="relative m-10 w-full  max-w-xs overflow-hidden rounded-lg bg-[#1A1F25] shadow-lg">
                <a href="#">
                ...
                <span class="absolute top-0 left-0 w-28 translate-y-4 -translate-x-6 -rotate-45 bg-black text-center text-sm text-[#A6ADBA]">Sale</span>
                <div class="mt-4 px-5 pb-5">
                    <a href="#">
                        <h5 class="text-xl font-semibold tracking-tight text-[#A6ADBA]">Nike Air MX Super 5000</h5>
                    </a>
                    ...
                    <div class="flex items-center justify-between">
                        <p>
                            <span class="text-3xl font-bold text-[#A6ADBA]">$249</span>
                            <span class="text-sm text-[#A6ADBA] line-through">$299</span>
                        </p>
